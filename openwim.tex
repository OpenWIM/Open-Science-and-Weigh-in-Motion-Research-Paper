...
Although IS-WIM is the main internet channel about WIM research, some paper is not presented there. Some paper or documents listed there can be linked to another web sites, and so, some document could have a broken link. 

Another issue found is about open access of the publications. Not all papers are published with some open access license.

But some papers are licensed by a creative common license (i.e. some papers from University College Dublin Library).
